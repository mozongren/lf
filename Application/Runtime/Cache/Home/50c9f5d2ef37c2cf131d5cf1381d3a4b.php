...
<head>
    ...
    <link rel="stylesheet" href="/lf/Public/css/pintuer.css">
    <link rel="stylesheet" href="/lf/Public/css/admin.css">
    <script src="/lf/Public/js/jquery.js"></script>
    <script src="/lf/Public/js/js/pintuer.js"></script>
    <script src="/lf/Public/js/respond.js"></script>
    <script src="/lf/Public/js/admin.js"></script>
    ...
    <div class="line">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="media media-y">
                <a href="http://www.pintuer.com" target="_blank"><img src="/lf/Public/images/logo.png" class="radius" alt="后台管理系统" /></a>
            </div>
            <br /><br />
                ...
                <div class="panel-body" style="padding:30px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                            ...
                            <img src="/lf/Public/images/passcode.jpg" width="80" height="32" class="passcode" />
                        </div>
                    </div>
                </div>
